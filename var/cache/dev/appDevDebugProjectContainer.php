...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.deployer' => 'getApp_DeployerService',
            'app.projectconfig' => 'getApp_ProjectconfigService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Trimm\Jelastic\Service\Api A Trimm\Jelastic\Service\Api instance
     */
    protected function getApp_ApiService()
    {
        return $this->services['app.api'] = new \Trimm\Jelastic\Service\Api($this->get('app.cache'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Trimm\Jelastic\Service\Cache A Trimm\Jelastic\Service\Cache instance
     */
    protected function getApp_CacheService()
    {
        return $this->services['app.cache'] = new \Trimm\Jelastic\Service\Cache();
    }

    /**
     * Gets the 'app.deployer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Trimm\Jelastic\Service\Deployer A Trimm\Jelastic\Service\Deployer instance
     */
    protected function getApp_DeployerService()
    {
        return $this->services['app.deployer'] = new \Trimm\Jelastic\Service\Deployer($this->get('app.projectconfig'), $this->get('app.api'));
    }

    /**
     * Gets the 'app.projectconfig' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Trimm\Jelastic\Service\ProjectConfig A Trimm\Jelastic\Service\ProjectConfig instance
     */
    protected function getApp_ProjectconfigService()
    {
        return $this->services['app.projectconfig'] = new \Trimm\Jelastic\Service\ProjectConfig();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8va5etL2AD', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('csZZQMDeGy', 0, 'JRxapUl+zI+l59Sja0UZWp', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => $this->get('kernel.class_cache.cache_warmer'), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator')), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\ValidatorCacheWarmer($this->get('validator.builder'), (__DIR__.'/validation.php'), \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kJFnC-DMmv', 0, 'JRxapUl+zI+l59Sja0UZWp', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE))), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 4 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\AnnotationsCacheWarmer(${($_ = isset($this->services['annotations.reader']) ? $this->services['annotations.reader'] : $this->getAnnotations_ReaderService()) && false ?: '_'}, (__DIR__.'/annotations.php'), ${($_ = isset($this->services['cache.annotations']) ? $this->services['cache.annotations'] : $this->getCache_AnnotationsService()) && false ?: '_'})));
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/jelastic/app/Resources');
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('wVnyw1rJKs', NULL, 'JRxapUl+zI+l59Sja0UZWp', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/jelastic/app/../var/sessions/dev');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('NonExistingToken');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/jelastic/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NVAFUasEUu', 0, 'JRxapUl+zI+l59Sja0UZWp', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'JelasticBundle' => 'Trimm\\Jelastic\\JelasticBundle',
                'DebugBundle' => 'Symfony\\Bundle\\DebugBundle\\DebugBundle',
            ),
            'kernel.bundles_metadata' => array(
                'FrameworkBundle' => array(
                    'parent' => NULL,
                    'path' => '/jelastic/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ),
                'MonologBundle' => array(
                    'parent' => NULL,
                    'path' => '/jelastic/vendor/symfony/monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ),
                'JelasticBundle' => array(
                    'parent' => NULL,
                    'path' => '/jelastic/src/Trimm/Jelastic',
                    'namespace' => 'Trimm\\Jelastic',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
                    'path' => '/jelastic/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle',
            ...
            'kernel.secret' => 'NonExistingToken',
            ...
            'session.save_path' => '/jelastic/app/../var/sessions/dev',
            ...
            'router.resource' => '/jelastic/app/config/routing_dev.yml',
